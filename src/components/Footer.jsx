export default function Footer() {
  return (
    <footer id="cta" className="bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="flex flex-col items-start justify-between gap-8 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 p-8 sm:flex-row sm:items-center">
          <div>
            <h3 className="text-2xl font-extrabold">Ready to hire faster?</h3>
            <p className="mt-1 max-w-xl text-sm/6 opacity-90">Start free in minutes, or book a live walkthrough with our team.</p>
          </div>
          <div className="flex gap-3">
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center rounded-lg bg-white px-4 py-2 text-sm font-semibold text-slate-900 transition hover:bg-slate-100"
            >
              Get started
            </a>
          </div>
